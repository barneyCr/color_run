...
namespace ColorRunServer
{
    ...
    public static class Extensions
    {
        ...
        {
            sock.Send(ColorRunServer.Network.Server.Encoding.GetBytes(String.Concat(msg, "\n")));
        }
        public static void Send(this Socket sock, string msg, params object[] p)
        {
            sock.Send(ColorRunServer.Network.Server.Encoding.GetBytes(String.Format(String.Concat(msg, "\n"), p)));
        }
        ...
        {
            return ColorRunServer.Network.Server.Encoding.GetString(bytes);
        }
        public static byte[] GetBytes(this string @string)
        {
            return ColorRunServer.Network.Server.Encoding.GetBytes(@string);
        }
